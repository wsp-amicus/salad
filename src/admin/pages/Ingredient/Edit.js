...
export class Edit extends Component {
  ...
  render() {
    ...
    const images = this.state.oldPictures.map(picture => {
      return <ImageWrapper url={picture} onRemove={this.handleOldDelete}><img src={`/${picture}`} className='img-responsive' alt='ingredient'/></ImageWrapper>
    })
    return (
